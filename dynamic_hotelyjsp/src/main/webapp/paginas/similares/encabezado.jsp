...
<body>
		...
		<div class="container">
			<div class="row justify-content-between">
				<div class="col d-flex align-items-center">
					<p class="mb-0 phone">
						<span class="address">Ubíquenos:</span> <a href="#">Av.
							Portaroblenos 1001</a> o al <span class="mailus"> Celular #:</span> <a
							href="#">+51 969696969</a> o al <span class="mailus">E-mail:</span>
						<a href="#">grupo@utp.edu.pe</a>
					</p>
				</div>
				<div class="col d-flex justify-content-end">
					<div class="social-media">
						<p class="mb-0 d-flex">
							...
							<a href="#"
								class="d-flex align-items-center justify-content-center">Visitenos<i
								class="sr-only">Facebook</i>>
							</a> <a href="#"
	...
	<nav
		...
		id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html">Vacaciones<span>
					con el GRUPO UTP</span></a>
